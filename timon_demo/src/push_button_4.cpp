...
int main(int argc, char** argv)
{
  ...
  //   ROS_INFO("Caixa na Horizontal");
    ...
    planning_scene_interface.addCollisionObjects(collision_objects);
      ...
      target_pose.orientation.x = transform_fake_button.getRotation().x(); //0.706395;//transform.getRotation().x();// // -0.522257;
      target_pose.orientation.y = transform_fake_button.getRotation().y(); ;//-0.707817;//transform.getRotation().y();//  // 0.47662;
      target_pose.orientation.z = transform_fake_button.getRotation().z(); ;// 0.000180;//transform.getRotation().z();//  // -0.523895
      ...
      // target_pose.orientation.w = transform_button.getRotation().w(); 
      // target_pose.orientation.x = transform_button.getRotation().x(); //0.706395;//transform.getRotation().x();// // -0.522257;
      // target_pose.orientation.y = transform_button.getRotation().y(); ;//-0.707817;//transform.getRotation().y();//  // 0.47662;
      // target_pose.orientation.z = transform_button.getRotation().z(); ;// 0.000180;//transform.getRotation().z();//  // -0.523895
